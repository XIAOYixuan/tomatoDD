...
class FACodecDecoderV2(nn.Module):
    def __init__(
        ...
        use_random_mask_residual=True,
        prob_random_mask_residual=0.75,
        output_latent="pcr", # prosody, content, residual
    ):
        super().__init__()
        self.hop_length = np.prod(up_ratios)
        self.ngf = ngf
        ...
        logger.info(f"output_latent: {self.output_latent}")
