...
from tomato.models.frontend_models.fairseq_models.modules.fairseq_dropout import FairseqDropout
from tomato.models.frontend_models.fairseq_models.modules.quant_noise import quant_noise
#from tomato.models.frontend_models.fairseq_models.models.fairseq_incremental_decoder import FairseqIncrementalDecoder
...
# safely remove FairseqIncrementalDecoder because all functions are rewritten
class MultiheadAttention(nn.Module):
    ...
    def __init__(
        ...
        self.onnx_trace = False # By Yixuan: taken from FairseqDecoder
        self.adaptive_softmax = None # By Yixuan: taken from FairseqDecoder
        
        xformers_att_config = fairseq_utils.eval_str_dict(xformers_att_config)
